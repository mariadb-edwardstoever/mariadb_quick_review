...
select '$RUNID' as RUN_ID, current_user() as RUN_BY, @@hostname as RUN_ON, now() as RUN_START, '$CLIENT_HOST' as CLIENT_HOST, '$CLIENT_DT' as CLIENT_DT, '$CLIENT_OS_ACCT' as CLIENT_OS_ACCOUNT, @IS_PRIMARY as IS_PRIMARY, @IS_REPLICA as IS_REPLICA, @IS_GALERA as IS_GALERA
